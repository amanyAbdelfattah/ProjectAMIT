...
<div class="card mb-3" style="max-width: 100%;">
    ...
    <div class="col-md-8">
        <div class="card-body">
        <h5 class="card-title" style="font-size:23px; color:black; font-weight:500;">{{Auth::user()->name}}</h5>
        <p class="card-text d-block">Email Address: <span>{{Auth::user()->email}}</span></p>
        ...
        <p class="card-text d-block">Posts: <span>{{Auth::user()->post}}</span></p>
        </div>
    </div>
    </div>
</div>
