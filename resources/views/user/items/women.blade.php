...
@section('title') Women Items @endsection
@section ('content')
<section>
    ...
    <div class="container">
        ...
        <div class="All">
            <ul>
                ...
                <li><a href="{{route('women.items')}}" style="color: crimson; font-weight:500">{{__('UserIndex.WOMEN')}}</a></li>
                ...
                <div class="swiper-slide">
                    <div class="container">
                        <div class="row flex-row flex-wrap align-items-stretch">
                            @foreach ($womenitems as $womenitem)
                            @if ($womenitem->ptype == "Featured" AND $womenitem->cat_id == "1")
                            <div class="box">
                                <div class="products">
                                    <div class="img-overlay1">
                                        ...
                                        <div class="img-overlay2">
                                            <img src="{{asset('uploads/products/' . $womenitem->pimg)}}" alt="">
                                        </div>
                                ...
                                <div class="price">
                                    <span> {{$womenitem->pprice}} L.E</span>
                                </div>
                                <div class="text">
                                    <h2>{{$womenitem->pname}}</h2>
                                    <div class="star">
                                    ...
                                    <div class="sm-icons">
                                        ...
                                        <div><a href="{{route('cart.add' , $womenitem->id)}}"><i class="fas fa-shopping-cart"></i></a></div>
