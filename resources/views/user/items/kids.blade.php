...
@section('title') Kids Items @endsection
@section ('content')
<section>
    ...
    <div class="container">
        ...
        <div class="All">
            <ul>
                ...
                <li><a href="{{route('kids.items')}}" style="color: crimson; font-weight:500">{{__('UserIndex.KIDS')}}</a></li>
            </ul>
        </div>
        <!-------------------------------------------Start Swiper-------------------------------------------->
        <div class="swiper-container mySwiper">
                ...
                <div class="swiper-slide">
                    <div class="container">
                        <div class="row flex-row flex-wrap align-items-stretch">
                            @foreach ($kidsitems as $kidsitem)
                            @if ($kidsitem->ptype == "Featured" AND $kidsitem->cat_id == "3")
                            <div class="box">
                                <div class="products">
                                    <div class="img-overlay1">
                                        ...
                                        <div class="img-overlay2">
                                            <img src="{{asset('uploads/products/' . $kidsitem->pimg)}}" alt="">
                                        </div>
                                ...
                                <div class="price">
                                    <span> {{$kidsitem->pprice}} L.E</span>
                                </div>
                                <div class="text">
                                    <h2>{{$kidsitem->pname}}</h2>
                                    <div class="star">
                                    ...
                                    <div class="sm-icons">
                                        ...
                                        <div><a href="{{route('cart.add' , $kidsitem->id)}}"><i class="fas fa-shopping-cart"></i></a></div>
